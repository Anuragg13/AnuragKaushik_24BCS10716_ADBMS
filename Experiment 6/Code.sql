...
CREATE VIEW emp_krgi AS 
SELECT emp_id, emp_name
FROM employees
WHERE emp_id = 101;

SELECT * FROM emp_krgi;


DELETE FROM emp_krgi
WHERE emp_id = 101;


CREATE MATERIALIZED VIEW emp_krgi_mat AS
SELECT emp_id, emp_name
FROM employees
WITH NO DATA;


SELECT * FROM emp_krgi_mat;


REFRESH MATERIALIZED VIEW emp_krgi_mat;
